...
;; Module hash : UbAj2RYupaT-x4vrBv8VcSzY9VN7EVe5yjLXiflqqds
;; Tx hash     : 
;; Interfaces  : fungible-xchain-v1, fungible-v2, kaddex.supply-control-v1, kaddex.special-accounts-v1
;; Source fetched from chain 1 via (describe-module "kaddex.kdx")
