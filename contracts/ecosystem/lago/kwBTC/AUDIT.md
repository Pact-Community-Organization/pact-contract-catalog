# AUDIT — lago.kwBTC (Wrapped BTC Shell)
...
| **On-Chain Hash** | `eMK6d8w17TqILbIYcbvhOWsMX49r5W5jqHdpRCLsDJY` |
...
`lago.kwBTC` is a **namespace governance shell** — not a functional token contract.
...
Reviewed: 2026-03-02 via `(describe-module "lago.kwBTC")` on mainnet01.
